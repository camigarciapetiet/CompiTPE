...
operador_asignacion	: ID {chequeoS_variable_no_declarada($1); $$=$1;} //Esto ya no permite que se pongan funciones para asignar
;
...
expresion	: expresion '+' termino {chequeoS_diferentes_tipos($0, $1); $$= new Nodo($2, $1, $3);}
			| expresion '-' termino {chequeoS_diferentes_tipos($0, $1); $$= new Nodo($2, $1, $3);}
			| termino {$$= $1;}
;

termino		: termino '/' factor {chequeoS_diferentes_tipos($0, $1); $$= new Nodo($2, $1, $3);}
			| termino '*' factor {chequeoS_diferentes_tipos($0, $1); $$= new Nodo($2, $1, $3);}
			| factor {$$= $1;}
			| termino '/' invocacion_funcion {chequeoS_diferentes_tipos($0, $1); $$= new Nodo($2, $1, $3);}
			| termino '*' invocacion_funcion {chequeoS_diferentes_tipos($0, $1); $$= new Nodo($2, $1, $3);}
...
condicion	: expresion {$$=new Nodo("condicion", $1, null);}
			| condicion operador_logico expresion {chequeoS_diferentes_tipos($0, $1); $$= $1.setHijos($1, $3);}
;
